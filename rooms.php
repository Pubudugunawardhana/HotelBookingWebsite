                    ...
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" sytel="font-size: 18px ;">CHECK AVAILABILITY</h5>
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" sytel="font-size: 18px ;">FACILITIES</h5>
                                <div class="mb-2">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" sytel="font-size: 18px ;">GUESTS</h5>
                                <div class="d-flex">
                                    <div class="me-3">
                ...
                <div class="card mb-4 border-0 shadow">
                    <div class="row g-0 p-3 align-items-center">
                        ...
                        <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
                          ...
                          <a href="#" class="btn btn-sm w-100 btn-outline-dark shadow-none">More datails</a>
                        </div>
                    </div>
                </div>

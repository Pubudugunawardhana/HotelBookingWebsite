...
<body class="bg-light">
  ...
  <script>
    ...
    function get_general() {
      ...
      xhr.onload = function() {
        if (this.status === 200) {
          ...
          customAlert('error', 'Failed to fetch general settings!');
        }
      };

      xhr.onerror = function() {
        customAlert('error', 'An error occurred while fetching general settings!');
      };
    ...
    function upd_general(site_title_val, site_about_val) {
      ...
      xhr.onerror = function() {
        customAlert('error', 'An error occurred while updating general settings!');
      };
    ...
    function upd_shutdown(val) {
      ...
      xhr.onload = function() {
        if (this.responseText == '1') {
          customAlert('success', val == 1 ? 'Site has been shutdown!' : 'Shutdown mode off!');
          get_general();
        } else {
          customAlert('error', 'Failed to update shutdown mode!');
        }
      };

      xhr.onerror = function() {
        customAlert('error', 'An error occurred while updating shutdown mode!');
      };
